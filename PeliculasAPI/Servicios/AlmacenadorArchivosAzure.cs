...
namespace PeliculasAPI.Servicios
{
    public class AlmacenadorArchivosAzure : IAlmacenadorArchivos
    {
        ...
        public async Task<string> EditarArchivo(byte[] contenido, string extension, string contendor, string ruta, string contenType)
        {
            await BorrarArchivo(ruta, contendor);
            return await GuardarArchivo(contenido, extension, contendor, contenType);
        }

        public async Task<string> GuardarArchivo(byte[] contenido, string extension, string contendor, string contenType)
        {
